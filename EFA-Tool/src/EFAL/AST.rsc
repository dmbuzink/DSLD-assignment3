...
// Defining the Abstract Syntax for EFAL (Extended Finate Automation Language)


// Automation type: 1: DFA, 2: NFA, 3: NFA-epsilon
data Automaton = Automaton(int automationType, list[str] alphabet, list[Statement] statements, list[Integer] integers, list[Boolean] booleans, list[State] states);
...
data BooleanExpression = 
	...
	| BooleanComparison(bool val1, bool val2); // note: In the original syntax you may have: "if X" this can become a BooleanComparison with X and true. Likewise If not X with false
